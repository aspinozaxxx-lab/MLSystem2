...
архивные строки того же класса, итоговые pixel/object-метрики рассчитываются прямым инференсом явно назначенной
текущей основной сети класса. Задание `test_sample_f1` с `metric_target=test_sample` проходит через общую
...
для той же основной сети, ревизии состава, эффективного inference-шаблона, профиля и версии алгоритма. Смена
основной сети, шаблона или состава, создание набора и старт сервиса ставят недостающие оценки в очередь; страницы
