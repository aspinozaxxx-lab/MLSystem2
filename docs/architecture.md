...
Draw/Modify/Snap, смена роли/типа, удаление и undo. У выбранного полигона видны все вершины:
клик по ребру добавляет вершину, а `Delete` удаляет явно выбранную вершину; все правки проходят через
общую проверку footprint и историю undo. Для binary остаётся positive/hard negative, для multiclass
