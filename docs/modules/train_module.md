...
- `EpochMetrics` - поля `epoch`, `train_loss`, `train_optimizer_steps`, `train_skipped_optimizer_steps`, `val_loss`, `val_pixel_precision`, `val_pixel_recall`, `val_pixel_f1`, `val_positive_pixels`, `val_pred_positive_pixels`, `val_true_positive`, `val_false_positive`, `val_false_negative`, `val_best_threshold`, `val_best_threshold_pixel_f1`, `val_best_threshold_precision`, `val_best_threshold_recall`, `val_prob_mean`, `val_prob_min`, `val_prob_max`, `val_prob_p50`, `val_prob_p90`, `val_prob_p99`, `epoch_time_sec`.
