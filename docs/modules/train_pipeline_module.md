...
- `dataset_preparing.api` - подготовить общий tile pool и получить `train_vrt_xml`, `val_vrt_xml`, `pool_vrt_xml`, `annotation_file` или `class_annotations`.
