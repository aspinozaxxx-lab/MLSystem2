...
Профиль сохраняет алгоритм ноутбука; параметры новых запусков: до 100 эпох, batch 32,
ранняя остановка после 20 эпох без улучшения validation loss и лимит времени 3600 секунд.
...
полную нарезку, seed 42 и заданное число workers. Результаты и остановка с сохранением учитывают выбор best по loss.
