...
цветные поклассовые F1 по основным выборкам источников. Компактные показатели переносятся внутри своей области и
не конкурируют с названием датасета, количеством снимков и действиями. Открытие каталога не создаёт отдельный
расчёт.
