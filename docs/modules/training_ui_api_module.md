...
`rgb/nrg/ngb` JPEG с жёлтым двухпиксельным контуром и без него. Композиции соответствуют
`RED-GRN-BLU`, `NIR-RED-GRN` и `NIR-GRN-BLU`; JPEG строятся только при скачивании, а двоичный подбор
максимального качества `1..95` обеспечивает
