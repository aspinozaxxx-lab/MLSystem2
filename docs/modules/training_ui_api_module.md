...
Профиль сохраняет обработку изображений ноутбука, но использует независимую validation по целым снимкам
с исключением пересечений и выбор best по F1. Параметры новых запусков: до 300 эпох, batch 32,
